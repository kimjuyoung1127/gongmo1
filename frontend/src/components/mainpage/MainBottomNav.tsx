...
export const MainBottomNav = () => {
    ...
    const navItems = [
        ...
        { icon: FileText, label: 'Community', href: `/${lang}/community` }, // Changed to Community or Files based on image logic
        { icon: Plus, label: '', href: '#', isFab: true }, // Central FAB placeholder
        { icon: Wrench, label: 'Tools', href: `/${lang}/tools` },
        { icon: Settings, label: 'Settings', href: `/${lang}/settings` },
    ];

    return (
        <nav className="fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800 pb-6">
